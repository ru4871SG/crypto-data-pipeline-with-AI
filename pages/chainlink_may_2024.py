# %%
"""
Dash Page - Chainlink MAY 2024 Report
"""
...
collection_chainlink_1m_w_external = db.chainlink_1m_w_external_may_2024
collection_chainlink_1m_uniswap_data = db.chainlink_1m_uniswap_data_may_2024
collection_chainlink_1m_aave_data = db.chainlink_1m_aave_data_may_2024
...
def key_insights():
    return html.Div([
        html.H1("Chainlink (LINK) MAY 2024 Report", className="title-text", id="title_text_1"),
    ])

# Inform Dash that this is a page
dash.register_page(__name__, title='Chainlink MAY 2024 Report')
...
<html>
    <head>
        <meta charset="utf-8">
        <title>Chainlink MAY 2024 Report</title>
